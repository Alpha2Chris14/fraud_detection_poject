...
from .views import base,delete_data,upload_data,predict_csv_single,predict_csv_multi,predict_data_manually,view_data,retrieve_data_by_id,analysis,change_password,login2,account_details,add_files_multi,about,dashboard,userLogout,reports,upload_credit_data,verify_account_details,submit_verify_account_details,confirm_account_fraud,bank,approve,prediction_button,enter_form_data_manually,add_files_single
...
urlpatterns = [
    ...
    path('verify_account_details/',verify_account_details,name='verify_account_details'),
    path('submit_verify_account_details/',submit_verify_account_details,name='submit_verify_account_details'),
    path('confirm_account_fraud/',confirm_account_fraud,name='confirm_account_fraud'),
